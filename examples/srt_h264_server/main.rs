...
use clap::Parser;
use remotia::{common::command_line::parse_canvas_resolution_str, server::{capture::scrap::ScrapFrameCapturer, encode::ffmpeg::h264::H264Encoder, pipeline::waterfall::{WaterfallServerPipeline, WaterfallServerConfiguration}, send::srt::SRTFrameSender}};
...
async fn main() -> std::io::Result<()> {
    ...
    let pipeline = WaterfallServerPipeline::new(WaterfallServerConfiguration {
