...
use clap::Parser;
use remotia::{client::{decode::h264::H264Decoder, pipeline::waterfall::{WaterfallClientConfiguration, WaterfallClientPipeline}, receive::{srt::SRTFrameReceiver, tcp::TCPFrameReceiver}}, common::command_line::parse_canvas_resolution_str};
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let stream = TcpStream::connect(&options.server_address)?;
    let receiver = Box::new(TCPFrameReceiver::create(stream));
